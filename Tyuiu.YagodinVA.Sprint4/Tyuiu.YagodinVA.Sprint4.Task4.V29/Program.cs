...
using Tyuiu.YagodinVA.Sprint4.Task4.V29.Lib;
namespace Tyuiu.YagodinVA.Sprint4.Task4.V29
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* заполненный значениями с клавиатуры в диапазоне от 4 до 8.              *");
